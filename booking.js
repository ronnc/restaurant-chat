 ...
 * @param {string} url
 * @returns {import('./providers/base.js').BookingProvider | null}
 */
 ...
 *
 * @param {import('./providers/base.js').BookingDetails} details – must include bookingUrl
 * @returns {Promise<import('./providers/base.js').BookingResult>}
 */
export async function makeBooking(details) {
  ...
  try {
    ...
    return {
      success: false,
      message: `Booking error (${provider?.name || 'unknown'}): ${err.message}`,
    };
  } finally {
